...
*/
//$route['default_controller'] = 'Welcome';
$route['Register']='/Fundooacc/getRegisterValue';
$route['Login']='/Fundooacc/getLoginValue';
$route['Forgotpass']='/Fundooacc/getforgotValue';
$route['resetpass']='/Fundooacc/getresetValue';
$route['conformregi']='/Fundooacc/getconformValue';
